...
import StyledDesktopView from "../../views/DesktopView/StyledDesktopView";
    ...
    <>
      ...
      <StyledNavigation>
        ...
        <StyledUl visible={isNavExpanded}>
          <Link>
            {" "}
            <StyledLi>Sprawy</StyledLi>
          </Link>
          <Link>
            {" "}
            <StyledLi>Ranking prawników</StyledLi>
          </Link>
          <Link>
            {" "}
          ...
          <Link>
            {" "}
            <StyledLi>Premium</StyledLi>
          </Link>
          <Link>
            <StyledLi>Twój profil</StyledLi>
          </Link>
          <Link>
            <StyledLi
              onClick={() => {
