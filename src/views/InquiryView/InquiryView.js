...
import LawyerResponse
    from "../../components/LawyerResponse/LawyerResponse";



const InquiryView = ({getInquiryById, exactInquiry, isExactInquiryLoaded}) => {
